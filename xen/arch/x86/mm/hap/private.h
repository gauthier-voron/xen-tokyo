...
unsigned long try_hap_gva_to_gfn_2_levels(struct vcpu *v,
					  struct p2m_domain *p2m,
					  unsigned long gva, 
					  uint32_t *pfec);
unsigned long try_hap_gva_to_gfn_3_levels(struct vcpu *v,
					  struct p2m_domain *p2m,
					  unsigned long gva, 
					  uint32_t *pfec);
unsigned long try_hap_gva_to_gfn_4_levels(struct vcpu *v,
					  struct p2m_domain *p2m,
					  unsigned long gva, 
					  uint32_t *pfec);
...
unsigned long try_hap_p2m_ga_to_gfn_2_levels(struct vcpu *v,
    struct p2m_domain *p2m, unsigned long cr3,
    paddr_t ga, uint32_t *pfec, unsigned int *page_order);
unsigned long try_hap_p2m_ga_to_gfn_3_levels(struct vcpu *v,
    struct p2m_domain *p2m, unsigned long cr3,
    paddr_t ga, uint32_t *pfec, unsigned int *page_order);
unsigned long try_hap_p2m_ga_to_gfn_4_levels(struct vcpu *v,
    struct p2m_domain *p2m, unsigned long cr3,
    paddr_t ga, uint32_t *pfec, unsigned int *page_order);
